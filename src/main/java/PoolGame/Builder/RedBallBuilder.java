...
/** Builder for red ball */
public class RedBallBuilder implements BallBuilder {
     ...
     */
    public RedBallBuilder(BallType type, BallPocketStrategy action, ScoreStrategy scoreAction) {
        this.ballType = type;
        this.action = action;
