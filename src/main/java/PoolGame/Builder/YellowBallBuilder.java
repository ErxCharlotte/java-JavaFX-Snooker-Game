...
public class YellowBallBuilder implements BallBuilder {
     ...
     */
    public YellowBallBuilder(Ball.BallType type, BallPocketStrategy action, ScoreStrategy scoreAction) {
        this.ballType = type;
        this.action = action;
